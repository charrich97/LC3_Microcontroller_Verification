...
make regress > all_valid_instructions_test.txt
make merge_coverage
export  TEST_NAME=branch_test
make regress > branch_test.txt
make merge_coverage
export  TEST_NAME=additional_operands_test
make regress > additional_operands_test.txt
make merge_coverage
##export  TEST_NAME=register_test
##make regress > register_test.txt
##make merge_coverage
export  TEST_NAME=random_test
make regress > random_test.txt
make merge_coverage
